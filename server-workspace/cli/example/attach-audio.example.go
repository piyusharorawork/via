...
func AttachAudioExample() {
	err := core.AttachAudio(core.AttachAudioInput{
		...
		VideoPath:  "/Users/piyusharora/projects/via/assets/temp/rishikesh-output.mp4",
		OutputPath: "/Users/piyusharora/projects/via/assets/temp/rishikesh-output-with-audio.mp4",
	})
